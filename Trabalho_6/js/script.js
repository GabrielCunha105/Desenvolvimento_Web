...
// O arquivo etapas.json não é mais nescessário.
...
function comecarEtapa() {
  ...
  for (let i = 0; i < etapa['numeros']; i++) {
    ...
    // O template de string foi substituído por causa de erros com o jsdoc
...
function enviarVotos() {
  ...
  request.open('POST', 'registrarVoto.php', true);
